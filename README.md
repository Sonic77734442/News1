...
- **Repository Variables:** `OPENAI_MODEL`, `GOOGLE_NEWS_RSS_URLS`, `GOOGLE_NEWS_MAX_ITEMS`, `NEWS_MAX_ITEMS`, `MIN_RELEVANCE_SCORE`, `AUTO_CONTENT_AUTHOR_NAME`, `AUTO_PUBLISH`, `AUTO_PUSH_SOCIAL`, `SITE_URL`, `FALLBACK_IMAGE_URL`, `ENABLE_FACT_CHECK`, `MIN_FACT_SIGNALS`
